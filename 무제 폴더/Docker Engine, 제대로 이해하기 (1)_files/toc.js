...
const TOC_CARD = (function () {
  const TocCardController = function () {
    ...
    const init = function () {
      ...
      if (existsHTags) {
        document.getElementById('toc-elements').classList.add('display');
        initTocElementsCard();
        giveIdToHTags();
...
document.getElementById(TOC_BTN).onclick = function () {
  ...
  document.getElementById(TOC_BTN).children[0].style.display = 'none';
  ...
  document.getElementById(TOC_BTN).classList.remove('display');
};
